...
<body id="body">
    ...
    <?php
            ...
            $consulta = "EXECUTE dbo.sp_ConsultarCatalogoLicor";
            ...
            while ($fila = sqlsrv_fetch_array($ejecutar)){
                ...
                <div class="hotel">
                    ...
                    <br><br>
                    <p3>Tipo Maduracion: <?php echo $fila['TipoMaduracion'] ?></p3>
                    <br><br>
                    <p3>Edad de maduración: <?php echo $fila['Edad'] ?></p3>
                    <br><br>
                    <p3>Precio: <?php echo $fila['Precio'] ?></p3>
                    <br><br>
                    <a href="sucursalXlicor.php?IdLicor=<?php echo $fila['Id']; ?>">Comprar</a>
                    <br><br>
